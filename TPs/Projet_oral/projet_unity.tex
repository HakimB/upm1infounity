...
\textcolor{red}{Interdiction formelle d'utiliser l'asset-store de Unity ou de code Unity extérieur (Vous avez cependant la possibilité d'utiliser des ressources venant de Blender par exemple).}
